...
> [!IMPORTANT]
> **DM-MSTYLE-EXT 보드 안내**  
> 8주차와 9주차 실습에서는 DM-MSTYLE-EXT 보드를 사용합니다. 이 보드는 Arduino Mega 기반으로 제작되었으며, 7 Segment 디스플레이와 LCD가 이미 내장되어 있어 별도의 배선 없이 실습을 진행할 수 있습니다.
...
> 부트로더가 없는 보드는 Arduino IDE에서 직접 업로드가 불가능합니다. 반드시 사전에 부트로더 상태를 확인하고, 필요 시 부트로더를 재설치한 후 사용하세요.
